...
export default function AdminPage() {
  ...
  const [viewingKYC, setViewingKYC] = useState<{ user: UserWithBank } | null>(
    null
  );
      ...
      <UserDetailView
        ...
        onUpdate={async () => {
          ...
          if (user) {
            ...
            params.append(
              "is_superiormanager",
              user.is_superiormanager.toString()
            );
          }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Multi-Bank Administration Dashboard
              </p>
            </div>
      ...
      <div className="max-w-[1600px] mx-auto px-6 py-8">
        <Tabs defaultValue="users" className="space-y-6">
          <TabsList
            className={`grid w-full max-w-md h-12 ${
          ...
          <TabsContent value="users" className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm border p-6 mb-6 animate-in">
              ...
              <div className="flex flex-col md:flex-row gap-4 mb-4">
                ...
                <Select
                  value={filterKYC}
                  onValueChange={(v) => handleFilterChange("kyc", v)}
                >
                  <SelectTrigger className="md:w-1/4 h-11 border-gray-300">
