    ...
    <div className="bg-white border rounded-lg shadow-sm">
      <div className="px-4 py-3 border-b bg-gradient-to-r from-blue-50 to-indigo-50">
        ...
        <p className="text-xs text-gray-600 mt-1">
          Manage all balances and view transaction history
        </p>
      </div>
      ...
      <div className="p-4 space-y-4">
          ...
          <div>
            ...
            <div className="space-y-2">
              {fiatCurrencies.map((currency) => (
                <div
                  key={currency.key}
                  className="border rounded-lg p-3 bg-gradient-to-r from-white to-blue-50 hover:shadow-md transition-shadow"
                >
          ...
          <div>
            ...
            <div className="space-y-2">
              {cryptoCurrencies.map((currency) => (
                <div
                  key={currency.key}
                  className="border rounded-lg p-3 bg-gradient-to-r from-purple-50 to-white hover:shadow-md transition-shadow"
                >
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex-1">
                      <div className="text-xs font-semibold text-gray-500 uppercase mb-1">
        ...
        <div className="border-t pt-4">
            ...
            <div className="p-3 mb-3 border rounded-lg bg-blue-50 space-y-2">
              <div className="grid grid-cols-3 gap-2">
                <Input
                  ...
                  value={newTx.thType}
                  onChange={(e) =>
                    setNewTx({ ...newTx, thType: e.target.value })
                  }
                  className="h-8 text-xs"
                />
                <Input
                  ...
                  onChange={(e) =>
                    setNewTx({ ...newTx, thDetails: e.target.value })
                  }
                  className="h-8 text-xs"
                />
                <Input
                  ...
                  value={newTx.thPoi}
                  onChange={(e) =>
                    setNewTx({ ...newTx, thPoi: e.target.value })
                  }
                  className="h-8 text-xs"
                />
              </div>
              <div className="grid grid-cols-3 gap-2">
                <Input
                  ...
                  value={newTx.thEmail || ""}
                  onChange={(e) =>
                    setNewTx({ ...newTx, thEmail: e.target.value })
                  }
                  className="h-8 text-xs"
                />
                <Input
                ...
                />
                <Select
                  value={newTx.thStatus}
                  onValueChange={(v) => setNewTx({ ...newTx, thStatus: v })}
                >
              ...
              <Button onClick={handleAddTx} size="sm" className="h-8 text-xs">
                Add
              </Button>
            </div>
          )}
          ...
          <div className="border rounded-lg overflow-hidden">
            {transactions.length === 0 ? (
              <div className="text-xs text-gray-500 text-center py-6 bg-gray-50">
                No transactions
              </div>
            ) : (
                      ...
                      <tr key={tx.id} className="border-b hover:bg-gray-50">
                        {editingTxId === tx.id ? (
                          <>
                            ...
                            <td className="px-2 py-2">
                              <Select
                                value={editTxData.thStatus}
                                onValueChange={(v) =>
                                  setEditTxData({ ...editTxData, thStatus: v })
                                }
                              >
                          ...
                          <>
                            ...
                            <td className="px-2 py-2 text-gray-600 truncate max-w-[100px]">
                              {tx.thEmail}
                            </td>
                            <td className="px-2 py-2">
                              <span
                                className={`inline-block px-1.5 py-0.5 rounded text-xs font-semibold ${
                                  tx.thStatus === "Successful"
        ...
        <div className="border-t pt-4">
          <div className="flex items-center justify-between mb-3">
            <h4 className="text-xs font-bold text-gray-700 uppercase tracking-wide">
              Crypto Transactions ({cryptoTransactions.length})
            </h4>
            <Button
          ...
          {showAddCrypto && (
            <div className="p-3 mb-3 border rounded-lg bg-purple-50 space-y-2">
              <div className="grid grid-cols-5 gap-2">
                <Select
                  value={newCrypto.transaction_type}
                  onValueChange={(v) =>
                    setNewCrypto({ ...newCrypto, transaction_type: v })
                  }
                >
                  <SelectTrigger className="h-8 text-xs">
                    <SelectValue />
                ...
                <Select
                  value={newCrypto.crypto_type}
                  onValueChange={(v) =>
                    setNewCrypto({ ...newCrypto, crypto_type: v })
                  }
                >
                  <SelectTrigger className="h-8 text-xs">
                    <SelectValue />
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewCrypto({ ...newCrypto, description: e.target.value })
                  }
      ...
      <ConfirmDialog
        ...
        onOpenChange={(open) =>
          setDeleteConfirm({ open, id: null, type: null })
        }
